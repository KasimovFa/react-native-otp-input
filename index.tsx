        ...
        return (
            <View pointerEvents="none" key={index + "view"} testID="inputSlotView">
            {
              ...
              <TextInput 
                ...
                style={[defaultTextFieldStyle, codeInputFieldStyle]}  
                ref={ref => { this.fields[indexInput] = ref; }} onChangeText={text => {
                  this.handleChangeText(indexInput, text);
                 }} 
                 onKeyPress={({ nativeEvent: { key } }) => { this.handleKeyPressTextInput(indexInput, key); }} 
                 value={!clearInputs ? digits[indexInput] : ""} 
